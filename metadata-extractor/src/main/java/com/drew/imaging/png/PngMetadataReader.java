...
public class PngMetadataReader {
    ...
    public static Metadata readMetadata(@NotNull File file) throws PngProcessingException, IOException {
        ...
        try (InputStream inputStream = new FileInputStream(file)) {
            metadata = Metadata.readMetadata(inputStream, PngMetadataReader::readMetadata);
        }
    ...
    public static Metadata readMetadata(@NotNull InputStream inputStream)  {
        Iterable<PngChunk> chunks = null;
        try {
            chunks = new PngChunkReader().extract(new StreamReader(inputStream), _desiredChunkTypes);
        } catch (PngProcessingException | IOException e) {
            e.printStackTrace();
        }
